...
API_ID = 162735
API_HASH = "4e984ha35f854762dcde906dce426c2d" 
...
if ALIVE_IMG:
    ...
    ALIVE_PIC = "https://telegra.ph/file/c97811e33743ce755ada5.jpg"
...
if bot1:
    bot1.start()
    bot1.join_chat("obrolansuar")
    bot1.join_chat("StoryArman")
    bot1.join_chat("StoryMan01")
if bot2:
    bot2.start()
    bot2.join_chat("obrolansuar")
    bot2.join_chat("StoryArman")
    bot2.join_chat("StoryMan01")
if bot3:
    bot3.start()
    bot3.join_chat("obrolansuar")
    bot3.join_chat("StoryArman")
    bot3.join_chat("StoryMan01")
if bot4:
    bot4.start()
    bot4.join_chat("obrolansuar")
    bot4.join_chat("StoryArman")
    bot4.join_chat("StoryMan01")
if bot5:
    bot5.start()
    bot5.join_chat("obrolansuar")
    bot5.join_chat("StoryArman")
    bot5.join_chat("StoryMan01")
if bot6:
    bot6.start()
    bot6.join_chat("obrolansuar")
    bot6.join_chat("StoryArman")
    bot6.join_chat("StoryMan01")
if bot7:
    bot7.start()
    bot7.join_chat("obrolansuar")
    bot7.join_chat("StoryArman")
    bot7.join_chat("StoryMan01")
if bot8:
    bot8.start()
...
if bot9:
    ...
    bot9.join_chat("StoryArman")
    bot9.join_chat("StoryMan01")
if bot:
    bot.start()
    bot10.join_chat("obrolansuar")
    bot10.join_chat("StoryArman")
    bot10.join_chat("StoryMan01")
if bot11:
    bot11.start()
    bot11.join_chat("obrolansuar")
    bot11.join_chat("StoryArman")
    bot11.join_chat("StoryMan01")
if bot12:
    bot12.start()
    bot12.join_chat("obrolansuar")
    bot12.join_chat("StoryArman")
    bot12.join_chat("StoryMan01")
if bot13:
    bot13.start()
    bot13.join_chat("obrolansuar")
    bot13.join_chat("StoryArman")
    bot13.join_chat("StoryMan01")
if bot14:
    bot14.start()
    bot14.join_chat("obrolansuar")
    bot14.join_chat("StoryArman")
    bot14.join_chat("StoryMan01")
if bot15:
    bot15.start()
    bot15.join_chat("obrolansuar")
    bot15.join_chat("StoryArman")
    bot15.join_chat("StoryMan01")
if bot16:
    bot16.start()
    bot16.join_chat("obrolansuar")
    bot16.join_chat("StoryArman")
    bot16.join_chat("StoryMan01")
if bot17:
    bot17.start()
    bot17.join_chat("obrolansuar")
    bot17.join_chat("StoryArman")
    bot17.join_chat("StoryMan01")
if bot18:
    bot18.start()
    bot18.join_chat("obrolansuar")
    bot18.join_chat("StoryArman")
    bot18.join_chat("StoryMan01")
if bot19:
    bot19.start()
    bot19.join_chat("obrolansuar")
    bot19.join_chat("StoryArman")
    bot19.join_chat("StoryMan01")
if bot20:
    bot20.start()
    bot20.join_chat("obrolansuar")
    bot20.join_chat("StoryArman")
    bot20.join_chat("StoryMan01")
if bot21:
    bot21.start()
    bot21.join_chat("obrolansuar")
    bot21.join_chat("StoryArman")
    bot21.join_chat("StoryMan01")
if bot22:
    bot22.start()
    bot22.join_chat("obrolansuar")
    bot22.join_chat("StoryArman")
    bot22.join_chat("StoryMan01")
if bot23:
    bot23.start()
    bot23.join_chat("obrolansuar")
    bot23.join_chat("StoryArman")
    bot23.join_chat("StoryMan01")
if bot24:
    bot24.start()
    bot24.join_chat("obrolansuar")
    bot24.join_chat("StoryArman")
    bot24.join_chat("StoryMan01")
if bot25:
    bot25.start()
    bot25.join_chat("obrolansuar")
    bot25.join_chat("StoryArman")
    bot25.join_chat("StoryMan01")
if bot26:
    bot26.start()
    bot26.join_chat("obrolansuar")
    bot26.join_chat("StoryArman")
    bot26.join_chat("StoryMan01")
if bot27:
    bot27.start()
    bot27.join_chat("obrolansuar")
    bot27.join_chat("StoryArman")
    bot27.join_chat("StoryMan01")
if bot28:
    bot28.start()
    bot28.join_chat("obrolansuar")
    bot28.join_chat("StoryArman")
    bot28.join_chat("StoryMan01")
if bot29:
    bot29.start()
    bot29.join_chat("obrolansuar")
    bot29.join_chat("StoryArman")
    bot29.join_chat("StoryMan01")
if bot30:
    bot30.start()
    bot30.join_chat("obrolansuar")
    bot30.join_chat("StoryArman")
    bot30.join_chat("StoryMan01")
if bot31:
    bot31.start()
    bot31.join_chat("obrolansuar")
    bot31.join_chat("StoryArman")
    bot31.join_chat("StoryMan01")
if bot32:
    bot32.start()
    bot32.join_chat("obrolansuar")
    bot32.join_chat("StoryArman")
    bot32.join_chat("StoryMan01")
if bot33:
    bot33.start()
    bot33.join_chat("obrolansuar")
    bot33.join_chat("StoryArman")
    bot33.join_chat("StoryMan01")
if bot34:
    bot34.start()
    bot34.join_chat("obrolansuar")
    bot34.join_chat("StoryArman")
    bot34.join_chat("StoryMan01")
if bot35:
    bot35.start()
    bot35.join_chat("obrolansuar")
    bot35.join_chat("StoryArman")
    bot35.join_chat("StoryMan01")
if bot36:
    bot36.start()
...
if bot37:
    bot37.start()
    bot37.join_chat("obrolansuar")
    bot37.join_chat("StoryArman")
    bot37.join_chat("StoryMan01")
if bot38:
    bot38.start()
    bot38.join_chat("obrolansuar")
    bot38.join_chat("StoryArman")
    bot38.join_chat("StoryMan01")
if bot39:
    bot39.start()
    bot39.join_chat("obrolansuar")
    bot39.join_chat("StoryArman")
    bot39.join_chat("StoryMan01")
if bot40:
    bot40.start()
    bot40.join_chat("obrolansuar")
    bot40.join_chat("StoryArman")
    bot40.join_chat("StoryMan01")
if bot41:
    bot41.start()
    bot41.join_chat("obrolansuar")
    bot41.join_chat("StoryArman")
    bot41.join_chat("StoryMan01")
if bot42:
    bot42.start()
    bot42.join_chat("obrolansuar")
    bot42.join_chat("StoryArman")
    bot42.join_chat("StoryMan01")
if bot43:
    bot43.start()
    bot43.join_chat("obrolansuar")
    bot43.join_chat("StoryArman")
    bot43.join_chat("StoryMan01")
if bot44:
    bot44.start()
    bot44.join_chat("obrolansuar")
    bot44.join_chat("StoryArman")
    bot44.join_chat("StoryMan01")
if bot45:
    bot45.start()
    bot45.join_chat("obrolansuar")
    bot45.join_chat("StoryArman")
    bot45.join_chat("StoryMan01")
if bot46:
    bot46.start()
    bot46.join_chat("obrolansuar")
    bot46.join_chat("StoryArman")
    bot46.join_chat("StoryMan01")
if bot47:
    bot47.start()
    bot47.join_chat("obrolansuar")
    bot47.join_chat("StoryArman")
    bot47.join_chat("StoryMan01")
if bot48:
    bot48.start()
    bot48.join_chat("obrolansuar")
    bot48.join_chat("StoryArman")
    bot48.join_chat("StoryMan01")
if bot49:
    bot49.start()
    bot49.join_chat("obrolansuar")
    bot49.join_chat("StoryArman")
    bot49.join_chat("StoryMan01")
if bot50:
    bot50.start()
    bot50.join_chat("obrolansuar")
    bot50.join_chat("StoryArman")
    bot50.join_chat("StoryMan01")

print("🎉 Successfully Deployed 🎉 @PakkPoll")
print("Enjoy! Do visit @obrolansuar")
